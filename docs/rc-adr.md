...
Trong hạ tầng công nghệ thông tin quy mô lớn của Công ty Cổ phần An ninh mạng Acme (Acme Security \- Acme), việc giám sát trạng thái hoạt động của hạ tầng thiết bị là nhiệm vụ sống còn. Hệ thống **Server Management System (ACME-SMS)** được định hướng phát triển nhằm mục đích quản lý tập trung và kiểm tra tự động trạng thái hoạt động (On/Off) của toàn bộ danh sách server thuộc công ty.
...
Hồ sơ các quyết định kiến trúc lớn dưới đây đóng vai trò định hình khung kỹ thuật cho dự án ACME-SMS:
...
* **Hệ quả (Consequences)**:  
  ...
  * *Biện pháp giảm thiểu:* Hướng dẫn đội vận hành hạ tầng whitelist cấu hình cho phép IP của hệ thống ACME-SMS đi qua tường lửa của các server thành viên.
