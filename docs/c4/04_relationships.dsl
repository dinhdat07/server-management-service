...
frontend -> serverComp "CRUD & Import"
...
monitoringComp -> redis "Fetches target IPs"
monitoringComp -> externalServers "ICMP Ping"
monitoringComp -> elastic "Saves ping logs"
monitoringComp -> db "Updates server status"
...
reportingService -> reportingRepo "Reads Server Metadata"
reportingRepo -> db "Executes SQL"
reportingService -> elastic "Queries Uptime Stats"
reportingService -> notificationService "Triggers Email Rendering"
...
monitoringWorkerPool -> redis "Fetches Target Server IDs"
monitoringWorkerPool -> monitoringService "Delegates Evaluation"
monitoringWorkerPool -> externalServers "Sends ICMP Ping"
monitoringService -> serverStateStore "Reads/Writes State"
serverStateStore -> redis "Executes Redis Commands"
monitoringService -> monitoringRepo "Writes Server Status"
monitoringRepo -> db "Executes SQL"
monitoringService -> elastic "Writes Ping Logs"
